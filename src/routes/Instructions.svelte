	 ...
	 <div class="disclaimer" >
         ...
         much longer&mdash; or, conversely, a bus that takes 15 minutes to fight through the typical rush-hour
          snarls will cruise along in an unexpected spell of smooth sailing. Often the MBTA's predictions on when
            your bus will come are uncannily accurate; however, it <em>will happen</em> that <em>sometimes</em> the 
          ...
          <li>Lobby your State Legislature for more transportation funding going to the MBTA, so that they can
             bring you more-frequent buses, and less transportation funding going to support <em>cars</em>, the agents
            of traffic chaos.</li>
          </ul>
          ...
          back to 6. The Bus Alarm revises its decision on whether to show you the next bus
          as its predicted arrival time changes, so you can revise your decision regarding whether to scramble
          out the door now, or wait.
	  </div>
        <h2> Setting up your Bus Alarms</h2>
	To set up a new bus alarm, open the &ldquo;Route, Direction, and Stop Picker&rdquo; at the bottom of the page. 
        First, specify where you are traveling from.
	You could enter  latitude and longitude;
	or, look up the
        ...
        Pick the direction in which you want to travel, then pick your most convenient stop from the up to 3 stops closest
	to the given location. Optionally, you can enter
        a nickname for these settings&mdash; &ldquo;bus to work&rdquo; for example.<p/>
        As soon as you click &ldquo;Add Stop to Watch List&rdquo;, a new Bus Alarm is added to your page. Your browser will 
        remember your Bus Alarms.
        <h2>Focusing on your currently relevant Bus Alarm</h2>
        Suppose you have 2 alarms, &ldquo;bus to work&rdquo; and &ldquo;bus to tennis club&rdquo;. You have to go to work now; so the details 
         on when the bus to the tennis club is coming are, sadly, not relevant to you right now. You can minimize
        those details by clicking on the nickname&mdash; click on the the &ldquo;bus to tennis club&rdquo; text at the top of 
        ...
        You can re-order your list of bus alarms by dragging a nickname and dropping it onto another nickname;
         ...
         on the gear icon, and click the &ldquo;remove&rdquo; button.
        <h2>Alerting yourself on when it's time to go</h2> 
         ...
         Adjust the Yellow Alert time to 9 minutes to get the alert when it's time to hustle.
	 To get an <em>audible</em> alert,
          check the &ldquo;Beep during Yellow Alert&rdquo; option.
         (The Bus Alarm will only beep during the time window that you specify.)
	 Beeping is off by default, and if
         you re-load this page, any audible alerts will be turned off. 
        ...
        within 2 minutes, you may
         want to check the option to not show &ldquo;immediate&rdquo; buses, and define &ldquo;immediate&rdquo; as those coming within 2
         minutes.
      </div>
